...
newtype HermesCatchphrases = HermesCatchphrases String
instance fakerHermesCatchphrases :: Faker HermesCatchphrases where
  fake = HermesCatchphrases <$> sample hermes_catchphrases
...
hermes_catchphrases :: Array String
hermes_catchphrases =
