...
instance fakerNamePrefix :: Faker NamePrefix where
  fake = NamePrefix <$> sample name_prefix

newtype NameSuffix = NameSuffix String
instance fakerNameSuffix :: Faker NameSuffix where
  fake = NameSuffix <$> sample name_suffix
...
instance fakerDescription :: Faker Description where
  fake = Description <$> sample description

newtype Review = Review String
instance fakerReview :: Faker Review where
  fake = Review <$> sample review


name_prefix :: Array String
name_prefix =
  [ "??"
  , "???"
  , "##"
