...
instance fakerModel :: Faker Model where
  fake = Model <$> sample model

newtype BrandWithModel = BrandWithModel String
instance fakerBrandWithModel :: Faker BrandWithModel where
  fake = BrandWithModel <$> sample brand_with_model
