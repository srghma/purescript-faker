...
newtype Allergens = Allergens String
instance fakerAllergens :: Faker Allergens where
  fake = Allergens <$> sample allergens

newtype Dish = Dish String
instance fakerDish :: Faker Dish where
  fake = Dish <$> sample dish

newtype Descriptions = Descriptions String
instance fakerDescriptions :: Faker Descriptions where
  fake = Descriptions <$> sample descriptions

newtype Ingredients = Ingredients String
instance fakerIngredients :: Faker Ingredients where
  fake = Ingredients <$> sample ingredients

newtype Fruits = Fruits String
instance fakerFruits :: Faker Fruits where
  fake = Fruits <$> sample fruits

newtype Vegetables = Vegetables String
instance fakerVegetables :: Faker Vegetables where
  fake = Vegetables <$> sample vegetables

newtype Spices = Spices String
instance fakerSpices :: Faker Spices where
  fake = Spices <$> sample spices

newtype Measurements = Measurements String
instance fakerMeasurements :: Faker Measurements where
  fake = Measurements <$> sample measurements

newtype MeasurementSizes = MeasurementSizes String
instance fakerMeasurementSizes :: Faker MeasurementSizes where
  fake = MeasurementSizes <$> sample measurement_sizes

newtype MetricMeasurements = MetricMeasurements String
instance fakerMetricMeasurements :: Faker MetricMeasurements where
  fake = MetricMeasurements <$> sample metric_measurements

newtype Sushi = Sushi String
instance fakerSushi :: Faker Sushi where
  fake = Sushi <$> sample sushi

newtype EthnicCategory = EthnicCategory String
instance fakerEthnicCategory :: Faker EthnicCategory where
  fake = EthnicCategory <$> sample ethnic_category
...
measurement_sizes :: Array String
measurement_sizes =
  [ "1/4"
  , "1/3"
  , "1/2"
...
metric_measurements :: Array String
metric_measurements =
  [ "milliliter"
  , "deciliter"
  , "centiliter"
