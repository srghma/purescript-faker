...
newtype QuotesEmperor = QuotesEmperor String
instance fakerQuotesEmperor :: Faker QuotesEmperor where
  fake = QuotesEmperor <$> sample quotes_emperor

newtype QuotesPaul = QuotesPaul String
instance fakerQuotesPaul :: Faker QuotesPaul where
  fake = QuotesPaul <$> sample quotes_paul

newtype QuotesThufir = QuotesThufir String
instance fakerQuotesThufir :: Faker QuotesThufir where
  fake = QuotesThufir <$> sample quotes_thufir

newtype QuotesJessica = QuotesJessica String
instance fakerQuotesJessica :: Faker QuotesJessica where
  fake = QuotesJessica <$> sample quotes_jessica

newtype QuotesIrulan = QuotesIrulan String
instance fakerQuotesIrulan :: Faker QuotesIrulan where
  fake = QuotesIrulan <$> sample quotes_irulan

newtype QuotesMohiam = QuotesMohiam String
instance fakerQuotesMohiam :: Faker QuotesMohiam where
  fake = QuotesMohiam <$> sample quotes_mohiam

newtype QuotesGurney = QuotesGurney String
instance fakerQuotesGurney :: Faker QuotesGurney where
  fake = QuotesGurney <$> sample quotes_gurney

newtype QuotesLeto = QuotesLeto String
instance fakerQuotesLeto :: Faker QuotesLeto where
  fake = QuotesLeto <$> sample quotes_leto

newtype QuotesStilgar = QuotesStilgar String
instance fakerQuotesStilgar :: Faker QuotesStilgar where
  fake = QuotesStilgar <$> sample quotes_stilgar

newtype QuotesLietKynes = QuotesLietKynes String
instance fakerQuotesLietKynes :: Faker QuotesLietKynes where
  fake = QuotesLietKynes <$> sample quotes_liet_kynes

newtype QuotesPardotKynes = QuotesPardotKynes String
instance fakerQuotesPardotKynes :: Faker QuotesPardotKynes where
  fake = QuotesPardotKynes <$> sample quotes_pardot_kynes

newtype QuotesBaronHarkonnen = QuotesBaronHarkonnen String
instance fakerQuotesBaronHarkonnen :: Faker QuotesBaronHarkonnen where
  fake = QuotesBaronHarkonnen <$> sample quotes_baron_harkonnen

newtype QuotesPiter = QuotesPiter String
instance fakerQuotesPiter :: Faker QuotesPiter where
  fake = QuotesPiter <$> sample quotes_piter

newtype QuotesAlia = QuotesAlia String
instance fakerQuotesAlia :: Faker QuotesAlia where
  fake = QuotesAlia <$> sample quotes_alia

newtype QuotesMapes = QuotesMapes String
instance fakerQuotesMapes :: Faker QuotesMapes where
  fake = QuotesMapes <$> sample quotes_mapes

newtype QuotesDuncan = QuotesDuncan String
instance fakerQuotesDuncan :: Faker QuotesDuncan where
  fake = QuotesDuncan <$> sample quotes_duncan

newtype QuotesYueh = QuotesYueh String
instance fakerQuotesYueh :: Faker QuotesYueh where
  fake = QuotesYueh <$> sample quotes_yueh

newtype SayingsBeneGesserit = SayingsBeneGesserit String
instance fakerSayingsBeneGesserit :: Faker SayingsBeneGesserit where
  fake = SayingsBeneGesserit <$> sample sayings_bene_gesserit

newtype SayingsFremen = SayingsFremen String
instance fakerSayingsFremen :: Faker SayingsFremen where
  fake = SayingsFremen <$> sample sayings_fremen

newtype SayingsMentat = SayingsMentat String
instance fakerSayingsMentat :: Faker SayingsMentat where
  fake = SayingsMentat <$> sample sayings_mentat

newtype SayingsMuaddib = SayingsMuaddib String
instance fakerSayingsMuaddib :: Faker SayingsMuaddib where
  fake = SayingsMuaddib <$> sample sayings_muaddib

newtype SayingsOrangeCatholicBible = SayingsOrangeCatholicBible String
instance fakerSayingsOrangeCatholicBible :: Faker SayingsOrangeCatholicBible where
  fake = SayingsOrangeCatholicBible <$> sample sayings_orange_catholic_bible
...
quotes_emperor :: Array String
quotes_emperor =
  [ "Bring in that floating fat man, the Baron!"
  ]

quotes_paul :: Array String
quotes_paul =
...
quotes_pardot_kynes :: Array String
quotes_pardot_kynes =
...
quotes_baron_harkonnen :: Array String
quotes_baron_harkonnen =
...
sayings_bene_gesserit :: Array String
sayings_bene_gesserit =
...
sayings_orange_catholic_bible :: Array String
sayings_orange_catholic_bible =
