module Faker.BojackHorseman where
...
newtype TongueTwisters = TongueTwisters String
instance fakerTongueTwisters :: Faker TongueTwisters where
  fake = TongueTwisters <$> sample tongue_twisters
