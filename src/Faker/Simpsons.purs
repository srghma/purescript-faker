...
newtype EpisodeTitles = EpisodeTitles String
instance fakerEpisodeTitles :: Faker EpisodeTitles where
  fake = EpisodeTitles <$> sample episode_titles
