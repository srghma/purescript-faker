...
newtype HeavyEquipment = HeavyEquipment String
instance fakerHeavyEquipment :: Faker HeavyEquipment where
  fake = HeavyEquipment <$> sample heavy_equipment

newtype Materials = Materials String
instance fakerMaterials :: Faker Materials where
  fake = Materials <$> sample materials

newtype SubcontractCategories = SubcontractCategories String
instance fakerSubcontractCategories :: Faker SubcontractCategories where
  fake = SubcontractCategories <$> sample subcontract_categories

newtype Roles = Roles String
instance fakerRoles :: Faker Roles where
  fake = Roles <$> sample roles

newtype Trades = Trades String
instance fakerTrades :: Faker Trades where
  fake = Trades <$> sample trades

newtype StandardCostCodes = StandardCostCodes String
instance fakerStandardCostCodes :: Faker StandardCostCodes where
  fake = StandardCostCodes <$> sample standard_cost_codes


heavy_equipment :: Array String
heavy_equipment =
  [ "Excavator"
  , "Backhoe"
  , "Bulldozer"
...
subcontract_categories :: Array String
...
standard_cost_codes :: Array String
standard_cost_codes =
