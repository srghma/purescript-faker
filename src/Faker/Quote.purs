...
newtype Matz = Matz String
instance fakerMatz :: Faker Matz where
  fake = Matz <$> sample matz

newtype MostInterestingManInTheWorld = MostInterestingManInTheWorld String
instance fakerMostInterestingManInTheWorld :: Faker MostInterestingManInTheWorld where
  fake = MostInterestingManInTheWorld <$> sample most_interesting_man_in_the_world

newtype Robin = Robin String
instance fakerRobin :: Faker Robin where
  fake = Robin <$> sample robin

newtype SingularSiegler = SingularSiegler String
instance fakerSingularSiegler :: Faker SingularSiegler where
  fake = SingularSiegler <$> sample singular_siegler

newtype Yoda = Yoda String
...
most_interesting_man_in_the_world :: Array String
