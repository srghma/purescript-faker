...
newtype Seas = Seas String
instance fakerSeas :: Faker Seas where
  fake = Seas <$> sample seas

newtype Islands = Islands String
instance fakerIslands :: Faker Islands where
  fake = Islands <$> sample islands
...
quotes =
  ...
  , "The royalty and nobles are behind the fire... Believe me... This town smells worse than Gray Terminal. It smells like rotten people! If I stay here... I'll never be free! I'm... ashamed to be born a noble!"
