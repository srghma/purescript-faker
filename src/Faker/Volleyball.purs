...
newtype Team = Team String
instance fakerTeam :: Faker Team where
  fake = Team <$> sample team

newtype Player = Player String
instance fakerPlayer :: Faker Player where
  fake = Player <$> sample player

newtype Coach = Coach String
instance fakerCoach :: Faker Coach where
  fake = Coach <$> sample coach

newtype Position = Position String
instance fakerPosition :: Faker Position where
  fake = Position <$> sample position

newtype Formation = Formation String
instance fakerFormation :: Faker Formation where
  fake = Formation <$> sample formation
...
team =
  ...
  , "Pallavolo Gonzaga Giovani Milano"
  , "Pallavolo Parma"
  , "Panasonic Panthers"
  ...
  , "Volley Piacenza"
  , "Volley Treviso"
  , "Volleybalvereniging Visade Voorburg"
  , "Zamalek"
  , "Zenit Kazan"
