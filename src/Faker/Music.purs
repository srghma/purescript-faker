...
newtype Instruments = Instruments String
instance fakerInstruments :: Faker Instruments where
  fake = Instruments <$> sample instruments

newtype Bands = Bands String
instance fakerBands :: Faker Bands where
  fake = Bands <$> sample bands

newtype Albums = Albums String
instance fakerAlbums :: Faker Albums where
  fake = Albums <$> sample albums

newtype Genres = Genres String
