...
newtype Bs = Bs String
instance fakerBs :: Faker Bs where
  fake = Bs <$> sample bs

newtype Name = Name String
instance fakerName :: Faker Name where
  fake = do
    randomInt 0 2 >>= case _ of
      0 -> do
        Name.LastName v1 <- fake
        Suffix v2 <- fake
        pure $ Name $ v1 <> " " <> v2
      1 -> do
        Name.LastName v1 <- fake
        Name.LastName v2 <- fake
        pure $ Name $ v1 <> "-" <> v2
      _ -> do
        Name.LastName v1 <- fake
        Name.LastName v2 <- fake
        Name.LastName v3 <- fake
        pure $ Name $ v1 <> ", " <> v2 <> " and " <> v3
...
instance fakerProfession :: Faker Profession where
  fake = Profession <$> sample profession

newtype Type = Type String
instance fakerType :: Faker Type where
  fake = Type <$> sample type_

newtype SicCode = SicCode String
