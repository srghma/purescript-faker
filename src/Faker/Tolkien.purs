...
newtype Poems = Poems String
instance fakerPoems :: Faker Poems where
  fake = Poems <$> sample poems

newtype Locations = Locations String
instance fakerLocations :: Faker Locations where
  fake = Locations <$> sample locations

newtype Races = Races String
instance fakerRaces :: Faker Races where
  fake = Races <$> sample races

newtype Characters = Characters String
instance fakerCharacters :: Faker Characters where
  fake = Characters <$> sample characters

newtype LordOfTheRingsCharacters = LordOfTheRingsCharacters String
instance fakerLordOfTheRingsCharacters :: Faker LordOfTheRingsCharacters where
  fake = LordOfTheRingsCharacters <$> sample lord_of_the_rings_characters

newtype LordOfTheRingsLocations = LordOfTheRingsLocations String
instance fakerLordOfTheRingsLocations :: Faker LordOfTheRingsLocations where
  fake = LordOfTheRingsLocations <$> sample lord_of_the_rings_locations

newtype LordOfTheRingsQuotes = LordOfTheRingsQuotes String
instance fakerLordOfTheRingsQuotes :: Faker LordOfTheRingsQuotes where
  fake = LordOfTheRingsQuotes <$> sample lord_of_the_rings_quotes

newtype HobbitCharacter = HobbitCharacter String
instance fakerHobbitCharacter :: Faker HobbitCharacter where
  fake = HobbitCharacter <$> sample hobbit_character

newtype HobbitThorinsCompany = HobbitThorinsCompany String
instance fakerHobbitThorinsCompany :: Faker HobbitThorinsCompany where
  fake = HobbitThorinsCompany <$> sample hobbit_thorins_company

newtype HobbitQuote = HobbitQuote String
instance fakerHobbitQuote :: Faker HobbitQuote where
  fake = HobbitQuote <$> sample hobbit_quote

newtype HobbitLocation = HobbitLocation String
instance fakerHobbitLocation :: Faker HobbitLocation where
  fake = HobbitLocation <$> sample hobbit_location
...
lord_of_the_rings_characters :: Array String
...
lord_of_the_rings_locations :: Array String
lord_of_the_rings_locations =
  [ "Aglarond"
  , "Aldburg"
  , "Andustar"
  , "Angband"
...
lord_of_the_rings_quotes :: Array String
...
hobbit_thorins_company :: Array String
hobbit_thorins_company =
  [ "Thorin Oakenshield"
  , "Fili"
  , "Kili"
  , "Balin"
